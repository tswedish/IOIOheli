...
public class MainActivity extends IOIOActivity {
    ...
    public void successCallback(String channel, Object message) {
      ...
      try {
        ...
        JSONObject lastError = new JSONObject("{\"PitchErr\":"
            ...
            + ",\"PitchCorr\":"
            + Float.toString(autopilot.kPt * autopilot.uPt + autopilot.kIt
                * autopilot.uIt + autopilot.kDt * autopilot.uDt) + "}");
  ...
  class Looper extends BaseIOIOLooper {
    ...
    private void UpdateIOIOfromHelicopterState(Helicopter helicopter) {
      ...
      float tailPwrTrimmed = helicopter.getTailPwr() + helicopter.getTailTrim();
